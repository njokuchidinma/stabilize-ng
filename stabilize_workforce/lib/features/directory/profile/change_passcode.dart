...
class WorkforceChangePasscodeScreen extends StatelessWidget {
  const WorkforceChangePasscodeScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildPasscodeRow(surfaceContainerHigh, onSurfaceColor),
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Update Passcode', style: TextStyle(fontFamily: 'Inter', fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
                ),
              ),
            ],
          ),
  ...
  Widget _buildPasscodeRow(Color bgColor, Color textColor) {
    return Row(
